...
use environment::spinlock::SpinLockGuard;
...
pub trait File: Send + Sync + core::fmt::Debug {
  ...
  fn read(&self, offset: usize, dst: UserBufferMut<'_>, options: &io::OpenOptions)
    -> Result<usize>;

  fn write(&self, offset: usize, buf: UserBuffer<'_>, options: &io::OpenOptions) -> Result<usize>;
